                        ...
                        MaterialPageRoute(
                            builder: (context) => AboutPage5(
                                  ...
                                  fieldofstudyController:
                                      widget.fieldofstudyController,
                                  edustartdateController:
                                      widget.edustartdateController,
                                  eduenddateController:
                                      widget.eduenddateController,
                                  edudescriptionController:
                                      widget.edudescriptionController,
                                  iseduCurrentPosition:
                                      widget.iseduCurrentPosition,
                                  selectedSkills: selectedSkills,
                                )), // Replace AboutPage2 with the actual page name
                      );
                    })
